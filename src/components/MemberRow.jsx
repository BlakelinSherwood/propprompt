  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 sm:gap-4 items-center px-5 py-4 border-b border-[#1A3226]/5 last:border-0 hover:bg-[#FAF8F4]/50 transition-colors">
      <div className="sm:col-span-4 flex items-center gap-3">
        <div className="w-9 h-9 rounded-full bg-[#1A3226] flex items-center justify-center text-white text-xs font-semibold flex-shrink-0">
          {initials}
        </div>
        <span className="text-sm font-medium text-[#1A3226] truncate">
          {member.full_name || "—"}
        </span>
      </div>
